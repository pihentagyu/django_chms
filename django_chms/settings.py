"""
Django settings for django_chms project.
...
WSGI_APPLICATION = 'django_chms.wsgi.application'
...
TIME_FORMAT = '%I:%M%p'
DEFAULT_DAY_BEGIN = '00:00' # time from 0:00
DEFAULT_DAY_END = '23:59' # time up to 23:59
